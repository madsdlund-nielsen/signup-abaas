...
import { AGENDA_KIND_LABEL, getMyPrepNote, listAgendaItems, type AgendaItemKind } from "@/server/preparation";
...
export const metadata: Metadata = { title: "Forberedelse — Advisory Board Unlimited" };
...
export default async function MeetingPreparationPage({
  ...
  return (
    <main className="container stack">
      ...
      <h1 className="heading-2 heading--on-light">{formatStart(meeting.startsAt)}</h1>
      <p className="body">
      ...
      {myParticipation ? (
        <section className="stack measure">
          ...
          <p className="body">
            Dine {meeting.prepMinutes} betalte forberedelsesminutter. Kun du og administrator
            kan se denne tekst — ejeren kan ikke.
          </p>
