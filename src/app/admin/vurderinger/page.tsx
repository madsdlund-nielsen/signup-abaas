...
export default async function AdminRatingsPage() {
  ...
  return (
    <main className="container stack">
      ...
      <h1 className="heading-2 heading--on-light">Vurderinger pr. rådgiver</h1>
      <p className="body">
        Gennemsnit af de vurderinger ejere og partnere har afgivet efter afholdte møder.
        Vurderinger er fortrolige for den enkelte afgiver — kun denne side samler dem.
      </p>
      <p className="form__notice" role="status">
        Tallene er datagrundlag, ikke en offentlig score. De påvirker ikke board-matchingen:
        om rating skal indgå som tie-break er ikke besluttet endnu.
      </p>
      ...
      {summary.length > 0 ? (
        ...
        <p className="body">
          Ingen vurderinger endnu. De opstår når et møde er registreret som afholdt og en
          deltager har vurderet det.
        </p>
      )}
    </main>
  );
