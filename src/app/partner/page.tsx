...
export const metadata: Metadata = {
  title: "Partner — Advisory Board Unlimited",
};
  ...
  return (
    <>
      <PageHeader
        eyebrow={
          <>
            <Link href="/dashboard">Dashboard</Link> · Partner
          </>
        }
        title="Din partnerportal"
        lead="Dine møder, din forberedelse og din profil. Kompetence-tags styres af administratoren — de kan ikke redigeres her."
      />
      <PageBody>
        {!profile ? (
            ...
            <section className="stack measure">
              ...
              <form className="form" action={updateMyPartnerProfile}>
                ...
                <Field
                  name="languages"
                  label="Sprog"
                  defaultValue={profile.languages ?? undefined}
                />
                <Field
                  name="photo_url"
                  label="Billede-URL"
                  defaultValue={profile.photoUrl ?? undefined}
                />
                <TextArea
                  name="personal_info"
                ...
                <TextArea
                  name="short_bio"
                  label="Kort bio"
                  defaultValue={profile.shortBio ?? undefined}
                />
                <TextArea
                  name="long_bio"
                  label="Lang bio"
                  defaultValue={profile.longBio ?? undefined}
                />
